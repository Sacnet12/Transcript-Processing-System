...
<div class="container-fluid">
    ...
    <div style="margin-right:3%;width:80%">
     <h5 style="color:#fff; font-size: 15px;margin-left: 8%">Name: <?php echo $_SESSION["surname"];?> <?php echo $_SESSION["firstname"];?></h5>
         ...
         <ul>
          ...
          <li><a href="appapplnew.php">Apply</a></li>
    ...
    <div class="plateacc">
        ...
        <h3 style="padding-top:8.5%; text-shadow: .1rem .1rem .5rem black;">Update Profile</h3>
    ...
    <div class="row">
        ...
        <div class="row">
                ...
                <div class="col">
                    ...
                    <input type="text" name="modedel" id="myText" value="<?php echo $result['formDelivery']; ?>"  readonly maxlength="11" minlength="11" id="name" class="form-control py-2">
                  </div>
                 </div>  
                 <div class="row">
                <div class="col">
                    <label for="name"><span class="input-group-addon">Location</span></label>
                    <input type="text" name="modeloc"  id="myTexts" value="<?php echo $result['location']; ?>" readonly class="form-control py-2">
              ...
              <div class="row">
                <div class="col">
                    ...
                    <input type="text" name="gradrecepname" id="name" value="<?php echo $result['ReceiverName']; ?>" readonly class="form-control py-2">
                  </div>
                 <div class="col">
                    <label for="name"><span class="input-group-addon">Details Address of the Recepient</span></label>
                    <input type="text" name="gradrecepadd" value="<?php echo $result['ReceiverAddress']; ?>" readonly id="name" class="form-control py-2">
                  </div>
              </div>
