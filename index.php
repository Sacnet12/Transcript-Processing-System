...
<div class="row justify-content-center">
        ...
        <div class="col-sm-12">
            ...
            <div class="row">
              ...
              <div class="row">
                  <div class="col">
                    <label for="name"><span class="input-group-addon">Phone Number</span></label><br>
                    <input type="text" name="phoneno" id="phone" maxlength="15" minlength="10" class="form-control">
                  </div>
              </div>
