...
<div class="container-fluid">
    ...
    <div style="margin-right:3%;width:80%">
     ...
     <div style="width:96%; height:50px; background-color: #fff; margin-left: 8%">
            ...
            <?php 
                $queryapproved=mysqli_query($conn, "SELECT COUNT(*) FROM transcript_applications WHERE paystatus='1'");
           ...
           <div class="table-responsive-xl">
                    <table class="table table-striped" style="width:96%; font-size:12px; overflow-x:auto; margin-right: 10%; margin-top:30px; margin-left:3%;background:#fff;">
                        ...
                        <?php 
                         if (isset($_GET['searchbutton'])){
                                ...
                                $query=mysqli_query($conn, "SELECT * FROM transcript_applications WHERE TransgenStatus=1 ORDER BY DateProcessed desc");}
                    ...
                    while($result=mysqli_fetch_assoc($query)){
                        ...
                        <tr>
                            ...
                            <?php echo $result['ReceiverAdd'];?></td>
                            <td></a>

                              <a  href="generatetrans.php?dells=<?php echo $result['RegNo'];?>"><span><i class="fas fa-eye" style="font-size: 20px;"></i></span></a>
                            </td>
                            <td><?php if ($result['TransApproStatus']=='0') {?>
                                <a onclick = "return confirm('Are you sure the Transcript is Duly Signed and Ready?')" href="adminact.php?delts=<?php echo $result['AppRef']; ?>"><span class="btn btn-success btn-sm">Approves</span>
                            <?php  } if ($result['TransApproStatus']=='1') {?>
                                <a onclick = "return confirm('Are sure the Transcript is not yet Ready?')" href="adminact.php?delst=<?php echo $result['AppRef']; ?>"><span class="btn btn-warning btn-sm">Disapparoved</span>
