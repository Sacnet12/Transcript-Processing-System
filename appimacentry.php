...
<?php
  ...
  Redirect_to("appimacentry.php");
    }
    else {
       $query=mysqli_query($conn, "SELECT * FROM studentsdetails WHERE RegNo='$mactricno'");
        $result=mysqli_fetch_assoc($query);
        if (!$result)
        {
            $_SESSION["ErrorMessage"]= "Matric No not Found, Please Contact the Transcripts Unit for assistance(07033303729)";
            Redirect_to("appimacentry.php");
        }
        else{
          session_start();
...
<div class="container-fluid">
    ...
    <div class="plateacc">
        ...
        <h3 style="padding-top:8.9%; text-shadow: .1rem .1rem .5rem black;">New Application</h3>
...
<form method="post" action="" enctype="multipart/form-data">
  ...
  <p style="color:red">Enter your Mactriculation Number to start with</p>
   <?php echo Message(); 
        echo SuccessMessage(); 
    ?>
    ...
    <div class="row">
                    ...
                    <input type="text" name="mactricno" id="name"  value="" class="form-control py-2">
