                    ...
                    <table class="table table-striped" style="width:96%; font-size:12px; overflow-x:auto; margin-right: 10%; margin-top:30px; margin-left:3%;background:#fff;">
                        ...
                        <?php 
                         if (isset($_GET['searchbutton'])){
                                $search = $_GET['search'];
                                $query = mysqli_query($conn, "SELECT * FROM transcript_applications WHERE surname LIKE '%$search%' OR faculty LIKE '%$search%' OR onames LIKE '%$search%' OR AppRef LIKE '%$search%' OR RecRef LIKE '%$search%' OR formDelivery LIKE '%$search%' OR location LIKE '%$search%' OR DateApplied LIKE '%$search%'");
                              }
                              else{
