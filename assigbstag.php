...
<div class="container-fluid">
    ...
    <div class="plateacc">
        ...
        <h3 style="padding-top:2rem; text-shadow: .1rem .1rem .5rem black; padding-top: 10%">Assign Role</h3>
 ...
 <form method="post" id="myForm" action="actionassign.php">
          ...
          <?php } ?>
                ...
                <div class="row">
                    <div class="col">
                    <label for="name"><span class="input-group-addon">Assign Role</span></label>
                    <select class="form-control" id="categoryselect" name="role">
              <?php 
          global $conn;
          $view=mysqli_query($conn, "SELECT * FROM staffreg");
          $result=mysqli_num_rows($view);
