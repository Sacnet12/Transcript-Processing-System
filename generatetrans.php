...
<div class="container-fluid">
    ...
    <div class="plateacc">
        ...
        <h3 style="padding-top:2rem; text-shadow: .1rem .1rem .5rem black; padding-top: 10%">Generate Student Transcript</h3>
    ...
    <div style="background-color: #fff; width:100%; height: 100px; padding-left: 6%">
      <h3>Instruction</h3>

      <ul>
        <li>Ensure that you save the generated Transcript in PDF format into the Appropriate Folder</li>
      </ul>

    </div>
 <form method="post" id="myForm" action="actionassign.php">
                    <?php echo Message(); 
                            echo SuccessMessage(); 
                        ?>
                    <br>
...
<input type="text" name="mactricno" id="name" value="<?php echo $idFromurl ?>" class="form-control py-2">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col">
                            ...
                            <input type="submit" class="btn btn-outline-info col-md-3" value='Generate' style="float:right; margin-top:5px;color:#000;border-color:#000">
                        </div>
