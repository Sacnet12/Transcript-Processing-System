...
<div class="container-fluid">
  ...
  <span id="state"></span>
           ...
           ?>
             <table class="table" style="width:80%; content-align:center; font-size:14px; overflow-x: scroll; margin-top:30px; margin-right: 10%; margin-left:10%; background:#fff;background-color: #fff">
                        ...
                        <tr>
                            ...
                            <td style="width:60%"><?php echo $result["ReceiverAddress"]; ?></td>
