...
<div class="container-fluid">
    ...
    <div class="col-sm-9" style="background-color:#e2d9d9;">
        ...
        <h3 style="padding-top:8%; text-shadow: .1rem .1rem .5rem black;">All PAID APPLICATIONS</h3>
    ...
    ?>
                    ...
                    <table class="table table-striped" style="width:98%; font-size:12px; overflow-x:auto; margin-right: 10%; margin-top:30px; margin-left:3%;background:#fff;">
                        ...
                        <?php 
                         if (isset($_GET['searchbutton'])){
                                ...
                                $query=mysqli_query($conn, "SELECT * FROM transcript_applications WHERE paystatus=1 ORDER BY DatePaid desc");}
                    ...
                    while($result=mysqli_fetch_assoc($query)){
                        ...
                        <tr>
                            ...
                            <td><?php echo $result['DatePaid'];?></td>
